...
parser.add_argument("--polkachu", action="store_true", help="use the polkachu API instead of the registry")
parser.add_argument("--no_fileout", action="store_true", help="do not write successful seeds and persistent_peers results to a file")
